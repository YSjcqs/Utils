...
UNREALROOTPATH = /home/youshu/WorkSpace/UE_5.0
GAMEPROJECTFILE =/home/youshu/WorkSpace/Projects/Utils/Utils.uproject

TARGETS = \
	Utils-Linux-Debug  \
	Utils-Linux-DebugGame  \
	Utils-Linux-Test  \
	Utils-Linux-Shipping  \
	Utils \
	UtilsEditor-Linux-Debug  \
	UtilsEditor-Linux-DebugGame  \
	UtilsEditor-Linux-Test  \
	UtilsEditor-Linux-Shipping  \
	UtilsEditor \
...
Utils-Linux-Debug:
	 $(PROJECTBUILD) Utils Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Utils-Linux-DebugGame:
	 $(PROJECTBUILD) Utils Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Utils-Linux-Test:
	 $(PROJECTBUILD) Utils Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Utils-Linux-Shipping:
	 $(PROJECTBUILD) Utils Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Utils:
	 $(PROJECTBUILD) Utils Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UtilsEditor-Linux-Debug:
	 $(PROJECTBUILD) UtilsEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UtilsEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UtilsEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UtilsEditor-Linux-Test:
	 $(PROJECTBUILD) UtilsEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UtilsEditor-Linux-Shipping:
	 $(PROJECTBUILD) UtilsEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UtilsEditor:
	 $(PROJECTBUILD) UtilsEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
